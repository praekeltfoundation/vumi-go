...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('base', ['ContactGroup'])
        ...
        db.create_table('base_contact_groups', (
        ...
        db.create_unique('base_contact_groups', ['contact_id', 'contactgroup_id'])
