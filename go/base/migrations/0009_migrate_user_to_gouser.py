...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        """Migrate go.base.GoUser to auth.User."""
        old_users = orm.GoUser.objects.all()
        for old_user in old_users:
            new_user = orm['auth.User'].objects.create(
                date_joined=old_user.date_joined,
                email=old_user.email,
                first_name=old_user.first_name,
                id=old_user.id,
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 24, 42, 898761)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 24, 42, 898359)'}),
        ...
        u'base.gouser': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 24, 42, 897347)'}),
            ...
            'is_staff': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_superuser': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 24, 42, 897059)'}),
