...
from go.services.voucher_utils import BaseVoucherPoolForm, AjaxFormMixin
...
class VoucherQueryForm(forms.Form, AjaxFormMixin):
    ...
    def submit_query(self):
        ...
        results = self.voucher_service.audit_query(self.voucher_pool, msisdn)
        if results:
