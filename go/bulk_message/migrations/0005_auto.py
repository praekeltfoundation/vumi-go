...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field previewcontacts on 'Conversation'
        db.create_table('conversation_conversation_previewcontacts', (
        ...
        db.create_unique('conversation_conversation_previewcontacts', ['conversation_id', 'contact_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field previewcontacts on 'Conversation'
        db.delete_table('conversation_conversation_previewcontacts')
