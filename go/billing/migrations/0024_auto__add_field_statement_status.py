...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Statement.status'
        db.delete_column(u'billing_statement', 'status')
    ...
    models = {
        ...
        u'billing.statement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'statement_pending'", 'max_length': '20'}),
