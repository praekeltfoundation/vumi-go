...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LineItem.description'
        db.alter_column(u'billing_lineitem', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'LineItem.billed_by'
        db.alter_column(u'billing_lineitem', 'billed_by', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'LineItem.description'
        db.alter_column(u'billing_lineitem', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'LineItem.billed_by'
        db.alter_column(u'billing_lineitem', 'billed_by', self.gf('django.db.models.fields.CharField')(max_length=100))
