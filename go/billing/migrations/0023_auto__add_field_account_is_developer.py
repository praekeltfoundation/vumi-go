...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.is_developer'
        db.add_column(u'billing_account', 'is_developer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.is_developer'
        db.delete_column(u'billing_account', 'is_developer')
