...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Statement.title'
        db.alter_column(u'billing_statement', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Statement.type'
        db.delete_column(u'billing_statement', 'type')


        # Changing field 'Statement.title'
        db.alter_column(u'billing_statement', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
