...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageCost.provider'
        db.add_column(u'billing_messagecost', 'provider',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.provider'
        db.add_column(u'billing_transaction', 'provider',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageCost.provider'
        db.delete_column(u'billing_messagecost', 'provider')

        # Deleting field 'Transaction.provider'
        db.delete_column(u'billing_transaction', 'provider')
