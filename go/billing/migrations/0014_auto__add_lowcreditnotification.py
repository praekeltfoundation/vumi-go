...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LowCreditNotification'
        db.create_table(u'billing_lowcreditnotification', (
            ...
            ('threshold', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('credit_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=6)),
        ))
        db.send_create_signal(u'billing', ['LowCreditNotification'])


    def backwards(self, orm):
        # Deleting model 'LowCreditNotification'
        db.delete_table(u'billing_lowcreditnotification')
