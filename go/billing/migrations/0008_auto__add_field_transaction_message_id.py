...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.message_id'
        db.add_column(u'billing_transaction', 'message_id',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.message_id'
        db.delete_column(u'billing_transaction', 'message_id')
